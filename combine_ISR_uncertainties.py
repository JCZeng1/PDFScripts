...
samples = ["ttbar", "stopWt","stops","stopt"]
#labels = ["SysTheoryISR_Top","SysTheoryISR_Top","SysTheoryISR_Top","SysTheoryISR_Top",]
labels = ["SysTheoryISR_ttbar","SysTheoryISR_stop","SysTheoryISR_stop","SysTheoryISR_stop",]
uncertainty_sets = [
sys_names_Top_scale,sys_names_Top_scale,sys_names_Top_scale,sys_names_Top_scale
]
